...
export default class ApiService {
  ...
  static async getSingleProduct (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/product/getById/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getAllQuantityProduct () {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/admin/order/getOrderQuantity`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addInventory (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/inventory`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async deleteInventory (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/inventory/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async searchInventory (keyword) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/inventory/searchByName/${keyword}`,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
        }
  ...
  static async updateReport (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/report/updateReport/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async getProductBySupplierName (supplierName) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/product/getBySupplier/${supplierName}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addSupplier (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/supplier`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async updateSupplier (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/admin/supplier/updateSupplier/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async getSupplierById (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/supplier/getById/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async deleteSupplier (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/supplier/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addImportShipment (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/importshipments`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async updateImportShipment (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/admin/importshipments/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async getImportShipmentItemsById (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/importShipmentItems/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addImportShipmentItems (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/importShipmentItems`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async updateOrder (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/order/updateOrder/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async updateOrderStatus (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/admin/order/updateOrderStatus/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async updateOrderState (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/admin/order/updateOrderState/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async getNotification () {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/product/notification`,
        {
          headers: this.getHeader()
        }
      )
      ...
      console.error(
        'Lỗi khi lấy danh sach thong bao:',
        error.response?.data || error.message
      )
      throw error
    }
  ...
  static async deleteOrder (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/order/deleteOrder/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getUserrById (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/getInformation/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getOrderByOrderCode (code) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/order/getOrderByOrderCode/${code}`,
        {
          headers: this.getHeader()
        }
      )
      ...
      console.error(
        'Lỗi khi lấy thông tin bằng code:',
        error.response?.data || error.message
      )
      throw error
    }
  ...
  static async searchShelf (keyword) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/shelf/searchByName/${keyword}`,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
        }
  ...
  static async getProductByName (name) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/product/getByName/${name}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getShelfByProductName (name) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/shelf/allShelfCode/${name}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getOrderItemById (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/admin/orderItem/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getOrderItemByCode (id) {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/orderItem/getOrderItemByOrderCode/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async updateOrderItem (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/orderItem/updateOrderItem/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
  ...
  static async deleteOrderItem (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/orderItem/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async getAllEmployees () {
    try {
      const response = await axios.get(
        `${this.BASE_URL}/api/admin/user/getAll`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addEmployee (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/user/createUserAccount`,
        formData,
        {
          headers: this.getHeader()
        }
  ...
  static async deleteEmployee (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/user/${id}/delete`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async deleteCategory (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/category/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async addExport (formData) {
    try {
      const response = await axios.post(
        `${this.BASE_URL}/api/admin/export`,
        formData,
        {
          headers: this.getHeader()
        }
  ...
  static async deleteExport (id) {
    try {
      const response = await axios.delete(
        `${this.BASE_URL}/api/admin/export/${id}`,
        {
          headers: this.getHeader()
        }
      )
  ...
  static async updateExportState (id, formData) {
    try {
      const response = await axios.put(
        `${this.BASE_URL}/api/admin/export/updateExportStatus/${id}`,
        formData,
        {
          headers: this.getHeader(),
          'Content-Type': 'application/json'
